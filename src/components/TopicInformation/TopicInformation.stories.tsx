...
const meta: Meta<typeof TopicInformation>  = {
  title: 'Components/TopicInformation',
  component: TopicInformation,
  parameters: {
    layout: 'padded',
    docs: {
      description: {
        component: `\nThe TopicInformation component is a PDC specific implementation that adds chips to the top of a dataset page linking to the Topic details and archived data pages for the Topic associated with the dataset.`,
      },
    },
  },
  argTypes: {
    topicDetails: { control: 'object', description: 'Array of objects representing all topics' },
    theme: { control: 'object', description: 'Array of theme objects associated with the dataset to use for matching' },
  },
  decorators: [
    (Story) => (
      <MemoryRouter>
...
type Story = StoryObj<typeof TopicInformation>;
