...
const TopicInformation = ({topicDetails, theme} : {topicDetails: Array<Topic>, theme: Array<Theme>}) => {
  ...
  return (
    <div className="ds-l-col--12">
      ...
      {topicChips.map(chip => (
        <div className="ds-u-display--inline-block ds-u-fill--primary ds-u-radius--pill ds-u-padding-x--2 ds-u-padding-y--05 ds-u-margin-right--1 ds-u-font-size--sm"><Link to={chip.href} className="ds-u-color--white">{chip.text}</Link></div>
      ))}
    </div>
  )
}
