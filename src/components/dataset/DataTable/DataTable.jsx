                  ...
                  {headerGroup.headers.map((column, i) => {
                    ...
                    return (
                      <div
                        ...
                        aria-sort={column.isSortedDesc === true ? 'descending' : column.isSortedDesc === false ? 'ascending' : undefined}
                      >
                        <Tooltip
                        ...
                        <Tooltip
                          ...
                          tooltipClass={`resize-tooltip ${column.isResizing ? 'hide-resize-tooltip' : ''}`}
                          delayHide={0}
                        >
                          <button
                            ...
                            onKeyDown={(e) => {
                              const thisColumn = columnResizing.filter((col) => col.id === column.id)[0]
                              ...
                              switch (e.key) {
                                ...
                                case ' ':
                                  ...
                                  if (thisColumn.resizing) {
                                    setColumnResizing(columnResizing.map((item) => item.id === column.id ? { ...item, resizing: false } : item))
                                    ...
                                    setColumnResizing(columnResizing.map((item) => item.id === column.id ? { ...item, resizing: true } : item))
                                ...
                                case 'ArrowRight':
                                  ...
                                  if (thisColumn.resizing) {
                                    ...
                                    const updatedWidth = (Math.round(column.width + 10) > column.maxWidth) ? column.maxWidth : Math.round(column.width + 10)
                                    ...
                                    // Update the user
                                    setAriaLiveFeedback(`${column.Header} has been resized. The new width is ${updatedWidth} pixels.`)
                                  }
                                  break
                                ...
                                case 'ArrowLeft':
                                  ...
                                  if (thisColumn.resizing) {
                                    ...
                                    const updatedWidth = (Math.round(column.width - 10) < column.minWidth) ? column.minWidth : Math.round(column.width - 10)
                            ...
                            onBlur={() => {
                              setColumnResizing(columnResizing.map((item) => ({ ...item, resizing: false })))
                  ...
                  {headerGroup.headers.map((column, i) => {
                    return (
                      <div
                        ...
                        {...column.getHeaderProps()}
                        className={`th ${
                          column.filterValue ? 'filter-value' : null
                        }`}
                      >
                        <div>
