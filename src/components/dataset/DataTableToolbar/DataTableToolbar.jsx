      ...
      >
        ...
        >
          ...
          <div className={`table-controls${fullscreen ? ' fullscreen-table-controls' : ''}`}>
            ...
            {filterEnabled && (
              <div
                className={`table-control-item filter-dataset-container${
                  fullscreen ? ' fullscreen-table-control-item' : ''
                }`}
              >
                <Tooltip tooltip="Filter dataset" position="top" trigger="hover" show={showTooltip}>
                  <DataHeaderButton
                    ariaLabel="Filter dataset - Opens in a dialog"
                    text={filterText}
                    icon={filterIcon}
                ...
                <div className={`display-settings-${instanceId}`}>
                  ...
                  >
                    <DataHeaderButton
                      ...
                      icon="sliders-h"
                      secondary={popoverOpen ? 'caret-up' : 'caret-down'}
                      click={togglePopover}
                    />
                  </Tooltip>
                </div>
