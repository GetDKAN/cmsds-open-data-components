...
describe('FilteredDatasetResource component', () => {
  ...
  it('Matches snapshot', () => {
    const renderedFilteredDatasetResource = renderer.create(
  ...
  it('Dataset state columns are correct', () => {
    ...
    expect(datasetState.filteredResource.columns).toEqual(['col1', 'col2', 'col3', 'col4', 'col5', 'col6'])
  })
  ...
  it('Data table rows are properly filtered when triggered', () => {
    ...
    const filteredRows = datasetState.filteredTable.filterTypes.text(datasetState.filteredTable.rows, 'col6', 'M0023901')
