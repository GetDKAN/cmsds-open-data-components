                          ...
                          <li>
                            <a href={socialMediaLinks.youtube.url}>
                              <span className="dc-c-footer--svg-icon">
                                ...
                                <svg title="youTube Icon" className="svg-inline--fa fa-youtube fa-w-18 fa-inverse" data-fa-transform="shrink-3.5" aria-labelledby="svg-inline--fa-title-youtube" data-prefix="fab" data-icon="youtube" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                  <title id="svg-inline--fa-title-youtube">{socialMediaLinks.youtube.title ? socialMediaLinks.youtube.title : "CMS youtube"}</title>
